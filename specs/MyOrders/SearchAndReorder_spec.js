...
xit("Verify if user can search product by Order Number successfully", function() {
	
	homepageobj.clickOnmyOrders();
	
	 logger.log('info','Click My Orders');
	
	browser.sleep(4000);
	
	
	// verifyin the presence of Favorites element on my order page
...
// element present in first td of the table in first tr	
	...
	//verifying the product name is present in searching string 
	
	// exampe: https://archway-premiernutrition-qa.azurewebsites.net/orders/PN2122
	
	browser.getCurrentUrl().then(function(text){
		
		expect(text).toContain(actual_ordernum);
...
xit("launch report and welcome page", function() {
	...
	browser.navigate().to("C:\\Users\\NareshS\\eclipse-workspace\\protrract\\PM_Byer\\Reports\\screenshots\\report.html");
	...
	browser.navigate().to("C:\\Users\\NareshS\\eclipse-workspace\\protrract\\PM_Byer\\welcome.html");
